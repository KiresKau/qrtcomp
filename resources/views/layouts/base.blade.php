...
{{--                @yield('navbar-brand')--}}
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="{{ route('drivers') }}">Водители</a>
                        </li>
    ...
    <footer class="footer">
            ...
            <div class="row">
                ...
                <div class=" col-sm-4 col-md  col-6 col">
                    ...
                    <ul class="footer_ul_amrc">
                        ...
                        <li><a href="{{ $comp->link }}">{{ $comp->name }}</a></li>
                            @endforeach
                    </ul>
                ...
                <div class=" col-sm-4 col-md  col-12 col">
                    ...
                    <ul class="footer_ul2_amrc">
                        @foreach($contacts as $contack)
                        <li><a href="http://facebook.com/profile.php?id={{ $contack->group_face }}"><i class="fab fa-facebook fleft padding-right"></i> </a><p>Группа в facebook ...<a href="http://facebook.com/profile.php?id={{ $contack->group_face }}">http://facebook.com/profile.php?id={{ $contack->group_face }}</a></p></li>
                        @endforeach
                            @foreach($contacts as $contack)
                        <li><a href="https://twitter.com/{{ $contack->group_tw }}"><i class="fab fa-twitter fleft padding-right"></i> </a><p>Группа в twitter ...<a href="https://twitter.com/{{ $contack->group_tw }}">https://twitter.com/{{ $contack->group_tw }}</a></p></li>
                            @endforeach
                                @foreach($contacts as $contack)
                        <li><a href="https://t.me/{{ $contack->group_tel }}"><i class="fab fa-location-arrow fleft padding-right"></i> </a><p>Группа в telegram ...<a href="https://t.me/{{ $contack->group_tel }}">https://t.me/{{ $contack->group_tel }}</a></p></li>
                            @endforeach
                    </ul>
        ...
        <div class="container">
            <ul class="foote_bottom_ul_amrc">
                <li><a href="{{ route('home') }}">Главня</a></li>
                <li><a href="{{ route('news') }}">Новости</a></li>
                <li><a href="{{ route('contacts') }}">Контакты</a></li>
            </ul>
            <!--foote_bottom_ul_amrc ends here-->
            <p class="text-center">Company @2018 | QRT <a href="{{ route('welcome') }}">Компания перевозки зерна</a></p>

            <ul class="social_footer_ul">
                @foreach($contacts as $contack)
                <li><a href="http://facebook.com/profile.php?id={{ $contack->facebook }}"><i class="fab fa-facebook-f"></i></a></li>
                @endforeach
                    @foreach($contacts as $contack)
                <li><a href="https://twitter.com/{{ $contack->twitter }}"><i class="fab fa-twitter"></i></a></li>
                    @endforeach
                    @foreach($contacts as $contack)
                <li><a href=" www.linkedin.com/in/{{ $contack->linked_in }}"><i class="fab fa-linkedin"></i></a></li>
                    @endforeach
                    @foreach($contacts as $contack)
                <li><a href="https://www.instagram.com/{{ $contack->instagram }}"><i class="fab fa-instagram"></i></a></li>
                    @endforeach
            </ul>
