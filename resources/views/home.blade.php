...
@section('navbar-brand')
    ...
    @include('navbar-brand', ['title' => 'Главная'])
...
@section('body')
    ...
    @foreach($homes as $home)
        <div class="card" style="width: 18rem;">
            @if($home->image)<img src="{{ $home->image }}" class="card-img-top" alt="..." height="300" width="550">@endif
            <div class="card-body">
...
@section('center')
{{--    <img src="{{ $images->image_home }}" width="100" height="50" alt="base64 test">--}}
    <div id="centerhome">
...
@section('sidebar')
    <div class="card" id="cardhome" style="width: 18rem;">
        <div class="card-body">
            ...
            <p class="card-text">{{ $homess->body }}</p>
        </div>
    </div>
@endsection
